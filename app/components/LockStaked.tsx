...
export const LockStaked: FC<Props> = ({ lock: { account, publicKey }, users }) => {
  return (
    <div className="w-[80%] md:w-full md:max-w-5xl mx-auto flex flex-col md:flex-row justify-center items-center md:space-x-4">
      <Card
        className={`w-full flex-1 p-1 md:p-2 bg-primary text-white rounded-box border flex items-center justify-around`}
      >
      ...
      <Card
        className={`w-full flex-1 p-1 md:p-2 bg-primary text-white rounded-box flex items-center justify-around`}
      >
